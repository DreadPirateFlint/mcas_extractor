...
request_params['ctl00$ContentPlaceHolder1$ddYear'] = ['2016', '2015', '2014', '2013']
request_params['ctl00$ContentPlaceHolder1$ddSubject'] = ['ALL']
request_params['ctl00$ContentPlaceHolder1$ddStudentGroup'] = ['ALL', 'LEP', 'ECODIS', 'HIGH', 'SPED', 'BL', 'AI', 'AS', 'HS', 'MR', 'HP', 'WH']
